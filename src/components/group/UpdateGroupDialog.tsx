...
const UpdateGroupDialog: React.FC<UpdateGroupDialogProps> = ({ isVisible, onClose, onGroupUpdated, group }) => {
    ...
    const [coverPreview, setCoverPreview] = useState<string | null>(group.coverUrl || null);
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-white rounded-xl w-full max-w-2xl mx-4 shadow-2xl">
                <div className="flex justify-between items-center p-6 border-b">
                    <h2 className="text-2xl font-bold text-gray-800">Cập nhật thông tin nhóm</h2>
                    <button 
                        onClick={onClose} 
